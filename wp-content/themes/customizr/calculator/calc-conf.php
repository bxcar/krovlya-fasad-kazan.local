...
<div id="rowshablontop" style="display: none;">
    <div id="leftarr"><img src="<?= get_template_directory_uri(); ?>/calculator/img/online/leftarr128.png"/></div>
    <div id="rightarr"><img src="<?= get_template_directory_uri(); ?>/calculator/img/online/rightarr128.png"/></div>
</div>
<div id="rowshablonbottom" style="display: none;">
    ...
    <div id="domchlist">
        ...
        <div id="domch03" class="domch"><img
                    src="<?= get_template_directory_uri(); ?>/calculator/img/online/dom3vid1ch.png"/></div>
        <div id="domch04" class="domch"><img
    ...
    <div id="bottomleftarr" class="shbottomarr"><img
                src="<?= get_template_directory_uri(); ?>/calculator/img/online/leftarr128r.png"
                style="width:40px; height:47px;"/></div>
    <div id="tcslist">
    ...
    <div id="bottomrightarr" class="shbottomarr"><img
                src="<?= get_template_directory_uri(); ?>/calculator/img/online/rightarr128r.png"
                style="width:40px; height:47px;"/></div>
</div>
<div id="columnpodbor" style="z-index:1;">
    ...
    <div id="podbordomgarag" class="podborcell">
        <div class="podborrow" style="padding-top: 7px;">
            ...
            <div class="radiodomgarag" id="mdom"><img
                        src="<?= get_template_directory_uri(); ?>/calculator/img/online/radioch.png"/><span>Менять дом</span>
            </div>
            <div class="radiodomgarag" id="mgarag"><img
                        src="<?= get_template_directory_uri(); ?>/calculator/img/online/radiounch.png"/><span>Менять гараж</span>
            </div>
        </div>
    </div>
    ...
    <div id="podborselect" class="podborcell">
        <div class="podborrow" style="padding-top: 7px;">
            <span style="float:left; padding-right: 7px; font-size:14px;">1. ВЫБОР: </span>
            <div class="radioprioritet" id="potipuprof"><img
                        src="<?= get_template_directory_uri(); ?>/calculator/img/online/radioch.png"/><span>По материалу</span>
            </div>
            <div class="radioprioritet" id="pocvetu"><img
                        src="<?= get_template_directory_uri(); ?>/calculator/img/online/radiounch.png"/><span>По цвету</span>
            </div>
        </div>
    </div>
    <div id="podbortypeprofil" class="podborcell">
        ...
        <div class="podborrow">
            ...
            <div class="ptrelem ptr4" id="metal_blockhouse" data-description="Металлический сайдинг «Блок-хаус»">
                ...
                <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/fasad_metal_blockhouse.png"
                     alt=""/>
            </div>
    ...
    <div id="podbortypekrovlya" class="podborcell">
        ...
        <div class="podborrow">
            <div class="ptrelem ptr6" id="profnastil_10r" data-description="Кровельный профнастил 10R">
                ...
                <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/krovlya_profnastil_10r.png"
                     alt=""/>
            </div>
            <div class="ptrelem ptr6" id="profnastil_20r" data-description="Кровельный профнастил 20R">
                ...
                <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/krovlya_profnastil_20r.png"
                     alt=""/>
            </div>
            <div class="ptrelem ptr6" id="profnastil_21r" data-description="Кровельный профнастил 21R">
                ...
                <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/krovlya_profnastil_21r.png"
                     alt=""/>
            </div>
            <div class="ptrelem ptr6" id="profnastil_35r" data-description="Кровельный профнастил 35R">
                ...
                <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/krovlya_profnastil_35r.png"
                     alt=""/>
            </div>
            <div class="ptrelem ptr6" id="profnastil_60r" data-description="Кровельный профнастил 60R">
                ...
                <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/krovlya_profnastil_60r.png"
                     alt=""/>
            </div>
            <div class="ptrelem ptr6" id="profnastil_75r" data-description="Кровельный профнастил 75R">
                ...
                <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/krovlya_profnastil_75r.png"
                     alt=""/>
            </div>
        </div>
    ...
    <div id="podbortypecokol" class="podborcell">
        ...
        <div class="podborrow">
            ...
            <div class="ptrelem ptrwand" id="cokolwandstein_dolomit" data-description="Коллекция «Доломит»">
                ...
                <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/cokolwandstein_dolomit.png"
                     alt=""/>
            </div>
    ...
    <div id="podborcolor" class="podborcell">
        ...
        <div class="podborrow" id="podborcolormetal">
            ...
            <div id="cuprumsteel" class="ptrelem ptr7" style="background-color: #7E4C31;"
                 data-description="Cuprum Steel">
                <div class="frame">
                    <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/frame_3636.png" alt=""/>
                </div>
                <div class="overlayd">
        ...
        <div class="podborrow" id="podborcolorvinil">
            ...
            <div id="vgoldpes" class="ptrelem ptr7" style="background-color: #FCE3AB;"
                 data-description="Золотой песок premium">
                <div class="frame">
                    <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/frame_3636.png" alt=""/>
                </div>
                <div class="overlayd">
            ...
            <div id="vtemndub" class="ptrelem ptr7" style="background-color: #574543;"
                 data-description="Темный дуб ACA">
                <div class="frame">
                    <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/frame_3636.png" alt=""/>
                </div>
                <div class="overlayd">
        ...
        <div class="podborrow" id="podborcolorbrick">
            ...
            <div id="ifasad" class="ptrelem ptr7" style="background-color: #C0AB8B;"
                 data-description="Панели Я-Фасад - янтарный">
                <div class="frame">
                    <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/frame_3636.png" alt=""/>
                </div>
                <div class="overlayd">
            ...
            <div id="brrbro" class="ptrelem ptr7" style="background-color: #7E3000;"
                 data-description="Красно-коричневый">
                <div class="frame">
                    <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/frame_3636.png" alt=""/>
                </div>
                <div class="overlayd">
        ...
        <div class="podborrow" id="podborcolorwandstein">
            ...
            <div id="wsdarkbrn" class="ptrelem ptr7" style="background-color: #453836;"
                 data-description="Тёмно-коричневый">
                <div class="frame">
                    <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/frame_3636.png" alt=""/>
                </div>
                <div class="overlayd">
            ...
            <div id="wssvbrn" class="ptrelem ptr7" style="background-color: #D3BCA2;"
                 data-description="Светло-коричневый">
                <div class="frame">
                    <img src="<?= get_template_directory_uri(); ?>/calculator/img/online/frame_3636.png" alt=""/>
                </div>
                <div class="overlayd">
    ...
    <div id="podbordoborn" class="podborcell">
        ...
        <div id="dobornfasadauto" class="podborrow" style="height:50%;">
            <table style="width:255px;">
                ...
                <tr>
                    <td>
                        <input id="dbfchinp" type="checkbox" checked="checked" onchange="dbfch()"
                ...
                <td style="width:140px;">
                    <div id="icon-minimize">
                        <table>
                            <tbody>
                            <tr>
                                <td style="width:90px; text-align: right; margin-right: 3px; font-size: 13px;"><span
                                            id="spiconmin" style="cursor: pointer;">Развернуть</span></td>
                                <td style="width:50px;"><img
                                            src="<?= get_template_directory_uri(); ?>/calculator/img/online/maximizeicon.png"/>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
<div id="original_link"
    ...
    <a href="https://vk.com/public160361618" target="blank"
       style="color: #004AE8;position: absolute;bottom: 2px;margin-left: 100px;" alt="Подбор кровли, фасада Grabdline"
       title="Подбор кровли, фасада">vk.com/public160361618</a>
    <div id="vk_like"></div>
